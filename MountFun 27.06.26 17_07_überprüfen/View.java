...
{   private Spielfigur_model spielfigur;
    ...
    private Highscore_view punktestand;
    ...
    public void HintergrundFestlegen(){
        ImageIcon icon = new ImageIcon(Dateipfad + "HintergrundOben2.png");
        JLabel l1 = new JLabel(icon);
        l1.setBounds(0, 0, icon.getIconWidth(), icon.getIconHeight());
        ImageIcon icon2 = new ImageIcon(Dateipfad + "HintergrundUnten2.png");
        JLabel l2 = new JLabel(icon2);
        l2.setBounds(0, 0, icon.getIconWidth(), icon.getIconHeight());
        System.out.println(Dateipfad);
        panel.setLayout(null);
        panel.add(l1,JLayeredPane.MODAL_LAYER);
        panel.add(l2,JLayeredPane.DEFAULT_LAYER);
        fenster.setContentPane(panel);
        fenster.setVisible(true);
        punktestand = new Highscore_view(panel,Dateipfad);
    }
    ...
    public void höchstpunktezahlSetzen(int punkte){
        JLabel höchstpunktezahl = new JLabel ("Highscore: "+punkte);
       
        
        höchstpunktezahl.setBounds(10, 10, 200, 100);
        höchstpunktezahl.setSize(200,40);
        höchstpunktezahl.setVisible(true);
        höchstpunktezahl.setForeground(Color.black);
        höchstpunktezahl.setFont(new Font("Impact",Font.ITALIC, 24));
        panel.add(höchstpunktezahl, JLayeredPane.POPUP_LAYER);
        panel.revalidate();
        panel.repaint();
    ...
    public void punktestandSetzen(int h){
        punktestand.punktestandSetzen(h);
    }

    public void fensterEntfernen(){
        fenster.dispose();
    }
