...
public class Controller implements KeyListener
{
    ...
    public void zufälligesHindernisHinzufügen(){
        ...
        if(zahl==1){
            ...
            int x = zufall2.nextInt(1600-verschiebungxl)+verschiebungxl;
            Schneemann_model scm1 = new Schneemann_model(x);
            while(überlapptMit(scm1)){
                x=zufall2.nextInt(1600-verschiebungxl)+verschiebungxl;
                scm1.xSetzen(x);
                scm1.ySetzen(1200);
            }
            ...
            x = zufall3.nextInt(1430-verschiebungxl)+verschiebungxl;
            ...
            int x = zufall6.nextInt(1660-verschiebungxl)+verschiebungxl;
            Münze_model mm1 = new Münze_model(x);
            while(überlapptMit(mm1)){
                x=zufall6.nextInt(1660-verschiebungxl)+verschiebungxl;
                mm1.xSetzen(x);
                mm1.ySetzen(800);
            }
            hindernisse.add(mm1);
