...
public class Controller implements KeyListener
{
        ...
        ActionListener task = new ActionListener() 
            {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if(i==20){
                        for(Hindernis_view hindernisse:baumrand){
                            baumNachObenRücken();
                        }
                        j=0;
                    }
                    ...
                    for(Hindernis_model h: hindernisse.getHindernisse()){
                        ...
                        if(spielfigur.kollidiertMit(h)){
                            if(h.getName().equals("Münze")){
                                ...
                                stopTakt();
                                GameOver_model gom = new GameOver_model();
                                view.GameOverHinzufügen(812,521,gom);
                            }
                        }
                    }
    ...
    public void baumHinzufügen(){
        ...
        int x1 = zufalla.nextInt(0,250);
        int x2 = zufallb.nextInt(1770,1920);
        Baum_view b1 = view.baumHinzufügen(x1,1000);
        Baum_view b2 = view.baumHinzufügen(x2,1000);
        view.baumHinzufügen(x1,1000);
        view.baumHinzufügen(x2,1000);        
